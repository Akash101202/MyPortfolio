...
export default function AboutMe({ onHandleSelect, activeState }) {
  return (
    <div className="px-8 bg-stone-900 text-stone-50 rounded-l-xl ">
      <div className="px-9 py-3">
        <div className="flex">
          <h1 className="px-3 pb-4 font-bold mb-3 mt-8">
            About Me
        ...
        <div className="flex gap-8 pb-3 card">
          ...
          <FloatingCard>
            <div className="flex gap-5">
              ...
              <h2 className="text-2xl font-bold mb-2">Learning Next js</h2>
            </div>
            <p className="text-stone-400 px-16">
      ...
      <h2 className="px-3 pb-4 font-bold mb-3 mt-8 ml-8">
        Other Interests
        <FaGripLines size={48} style={{ color: "gold" }} />
      </h2>
